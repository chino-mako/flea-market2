        ...
        <div class="payment-method" style="margin-top: 30px;">
            ...
            <form action="{{ route('purchase.store', $item->id) }}" method="POST">
                ...
                <div class="address" style="margin-top: 30px;">
                    <h3>配送先</h3>
                    @if ($user->addressRelation && $user->addressRelation->first())
                        <p>
                            〒{{ $user->addressRelation->first()->postal_code }}<br>
                            {{ $user->addressRelation->first()->address }}{{ $user->addressRelation->first()->building ?? '' }}
                        </p>
                ...
                {{-- 購入概要 --}}
                <div class="right-column" style="width: 300px; align-self: flex-start; margin-top: 30px;">
